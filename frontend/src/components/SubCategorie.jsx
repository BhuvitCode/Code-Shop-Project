...
const SubCategorie = (props) => {
    ...
    const {SubCategoriesArray} = props
    ...
    return (
        <>
            <section className="Category-Section">
                <h1 className='text-4xl font-bold text-center mt-10'>Product SubCategories</h1>
                ...
                <div className="Category-Container flex flex-wrap justify-center items-center mt-16">
                    <div className="Categorie1 w-72 h-72 bg-white flex-col justify-center mt-20 mx-10 items-center">
                        ...
                        <h1 className="CategoryName text-xl mt-10 ml-3 font-bold text-center">{SubCategoriesArray.Sub_Category_Name}</h1>
